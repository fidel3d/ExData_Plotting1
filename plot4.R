...
# creation of the plot and the plot4.png. No screen display ----
...
# plot creation for DateTime and Global_active_power
...
# plot creation for DateTime with all the meters
...
# plot creation for DateTime and Global_reactive_power
